//Definiți un TDA listă de întregi. Specificați ce operații doriți să fie definite pentru acest TDA. 
//Apoi propuneti un fișier de tip header pentru o implementare a unei biblioteci in C pentru TDA 
//abstract definit anterior
